module.exports.routes = {
     ...
     * Backend testing
     */
    '/api': 'StatusController.status',
    '/api/status': 'StatusController.status',
    '/api/system': 'StatusController.status',
     ...
     * Ipxe API
     */
    'get /api/ipxe': 'IpxeController.list',
    'get /api/ipxe/search': 'IpxeController.search',
    'get /api/ipxe/:id': 'IpxeController.find',
    'post /api/ipxe': 'IpxeController.create',
    'put /api/ipxe': 'IpxeController.update',
    'delete /api/ipxe': 'IpxeController.destroy',
